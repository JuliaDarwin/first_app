        ...
        <main>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-auto max-w-6xl my-15 px-10">
                ...
                <div className="bg-gray-100 ring-1 ring-gray-300 grid grid-rows-[1fr_auto] rounded-xl p-8 gap-6 text-center hover:scale-105 transform transition-transform">
                    <div className="grid grid-rows-[auto_auto_auto_1fr] gap-y-5">
                        <p className="text-indigo-600 text-lg font-bold">Conversational</p>
                        ...
                        <Link href="/about" className="text-center text-indigo-600 mt-5 p-2 bg-indigo-600/20 rounded-md hover:bg-black">Learn More</Link>
                ...
                {   /* Third lesson type */ }
                <div className="text-center bg-gray-100 ring-1 ring-gray-300 grid grid-rows-[1fr_auto] rounded-xl p-8 gap-6 hover:scale-105 transform transition-transform">
                    <div className="grid grid-rows-[auto_auto_auto_1fr] gap-y-5">
                        <p className="text-indigo-600 text-lg font-bold text-center">Exams</p>
                        ...
                        <Link href="/about" className="text-center mt-5 p-2 border-2 bg-indigo-600 text-white rounded-md hover:bg-black">Learn More</Link>
            ...
            <div className="ml-30 mt-20">
                ...
                <div className="flex flex-col-2 gap-4 items-center">
                    <p className="">Leave us a message with your request and we will get back to you as soon as possible!</p>
                    <Link href="/contact" className="ml-0 p-3 bg-indigo-600 text-white rounded-md hover:bg-black">Contact us</Link>
                </div>
